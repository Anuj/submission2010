...
advantage that QWERTY enjoys. \todo{add the results from
  Table~\ref{tab:StatisticsForTestCorpora} to the plot, and check out
  the qualitative results from the three users who got high accuracy}.
