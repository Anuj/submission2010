...
significance. However, to be more robust about our assumptions, we conducted an ANOVA with post-hoc tests which denoted that there is a significant difference between backside-QWERTY and Chording. We then conducted a two tailed t-test to validate this and the p-value turned out to be 0.02, which essentially means that the chording mechanism was significantly more accurate than the backside-QWERTY. 
...
same. It becomes clear from the graph that chording does the best on the accuracy axis and QWERTY does the best on the speed axis. However, backside-QWERTY, in terms of the speed vs accuracy tradeoff seems to have the highest potential to come close to QWERTY.
