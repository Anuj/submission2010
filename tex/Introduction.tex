...
\todo{citations}. As manufacturers start to include backside input in their devices, we have an opportunity to take advantage of this new input modality to improve the users speed, accuracy and comfort while entering text on their ``foot-scale'' devices.  A "natural" method of holding such a device is to have
...
We have designed a chording-based touch input mechansim specifically
...
Preliminary results show that our chording mechansim results in a
